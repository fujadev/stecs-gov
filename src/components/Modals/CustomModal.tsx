        ...
        {!children && variant === "releasePayment" && (
          <div className="flex flex-col items-center text-center w-[719px] py-[40px]">
            ...
            <div className="flex gap-[10px]">
              ...
              <button
                onClick={() => setOpened(false)}
                className="mt-[40px] rounded-[12px] bg-[#3A86FF] text-white w-[197px] h-[50px] text-[16px] font-semibold"
              >
                {releaseText}
              </button>
            </div>
        ...
        {!children && variant === "status" && (
          <div className="flex flex-col w-[719px] p-[40px]">
            <div className="flex justify-between items-center">
              <h1 className="text-[#003049] text-[24px] font-semibold">
                Invite Authorizer
              </h1>
            ...
            <h3 className="text-[16px] font-medium text-[#003049] mt-[24px]">
              Enter Authorizer Email
            </h3>
