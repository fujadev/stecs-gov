...
const AppHeader = () => {
	...
	return (
		<header className="flex items-center justify-between max-w-[1280px] mx-auto w-full wrapper-pad">
			...
			<Transition mounted={isMobileNavActive} transition="pop" duration={200} timingFunction="ease">
				{(styles) => (
					<div style={styles} className="lg:hidden bg-[white] fixed top-none left-none py-xl p-md z-50 w-full">
