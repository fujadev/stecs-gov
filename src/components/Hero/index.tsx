...
import horizontalBarChart from '@/assets/images/horizontalBarChart.png'
...
const HeroSection = () => {
  return (<section className="wrapper-pad w-[100%] max-w-[1253px] mx-auto flex max-lg:flex-col max-lg:items-center">
    <div className="max-lg:text-center w-full lg:max-w-[592px] pb-[90px] max-sm:pb-[32px]">
      ...
      <div className="flex items-center mt-[20px] gap-[12px] max-lg:justify-center">
        <AppStoreDark />
        <PlayStoreDark />
      </div>
    </div>
    <div className='max-h-[693px] h-[100%] w-auto relative max-sm:hidden'>
      ...
      <Image src={heroImg} alt="Stecs Features" />

      <div className='p-[12px] rounded-[20px] bg-[white] max-w-[265px] absolute bottom-[63px] max-md:left-[0px] left-[-100px]'>
    ...
    <Image src={heroImgM} alt="Features" className='sm:hidden' />
  </section>
  );
}
