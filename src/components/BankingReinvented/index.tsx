...
import phones from '@/assets/images/phonePairs.webp'
import phonesM from '@/assets/images/phonePairsM.webp'
    ...
    <section className="wrapper-pad mt-[45px] sm:mt-[96px] max-w-[1218px] w-full mx-auto">
      <div className="bg-[#20232D] rounded-[20px]">
        <div className="flex flex-col items-center pt-[90px] bg-[url('../assets/images/stecsLogoBg.png')]">
          ...
          <AppButton onClick={() => dispatch(setStoreModal(true))} color="#fff" fullWidth={false} classNames={{ root: "min-h-[43px] sm:min-h-[48px] mb-[20px] py-[14px] px-[12px] sm:px-[16px] rounded-[10px]" }}>
