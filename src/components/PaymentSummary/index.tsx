...
import { groupTableColumn, tableData2 } from '@/config/helpers/url';
	...
	return (
		<div className="max-w-[1137px]  w-full  rounded-[8px] mx-auto">
			...
			<div className="bg-[#FFFFFF] mt-[32px] py-[32px] px-[19px] rounded-[8px]">
				...
				<CustomTable columns={groupTableColumn} data={tableData2} />
			</div>

			<CustomModal variant="status" opened={inviteOpen} onClose={() => setInviteOpen(false)} />
		</div>
	);
};
